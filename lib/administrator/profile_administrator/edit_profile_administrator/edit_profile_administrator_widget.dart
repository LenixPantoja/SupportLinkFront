...
class EditProfileAdministratorWidget extends StatefulWidget {
  const EditProfileAdministratorWidget({super.key});

  @override
  State<EditProfileAdministratorWidget> createState() =>
      _EditProfileAdministratorWidgetState();
}

class _EditProfileAdministratorWidgetState
    extends State<EditProfileAdministratorWidget> {
  late EditProfileAdministratorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditProfileAdministratorModel());
